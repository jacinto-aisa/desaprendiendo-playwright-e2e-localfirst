// scripts/instrument-web-local.mjs
import fs from 'node:fs';
import path from 'node:path';
import { createInstrumenter } from 'istanbul-lib-instrument';

const sourceRoot = path.resolve('web-local');
const outputRoot = path.resolve('web-local-instrumented');
...
console.log(`Web instrumentada en: ${outputRoot}`);
